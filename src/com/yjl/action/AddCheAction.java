...
public class AddCheAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)	
		...
		String leixing=request.getParameter("leixing");//品牌
		String pic=request.getParameter("fujian");//图片
		String info=request.getParameter("info");//备注
		int uid=Integer.parseInt((String)request.getSession().getAttribute("uid"));//操作
